...
| `statcast_2026_min300_research.csv` | 378,007 | 446 | 2026-03-26 ~ 07-09 |

* 정규시즌(`game_type == R`)만, 투수-시즌 단위로 **시즌 투구 수 ≥ 500**(2026은 시즌 일부만 진행되어 **≥ 300**)인 투수의 모든 투구입니다.
* **2026 전반기 표본(07-09까지, 컷오프 300)은 팀에서 확인 중입니다.** 확정되면 이 문서와 분석 결과를 갱신합니다.
* 해외 개막전(2024 서울, 2025 도쿄 시리즈)과 2026-07-10 이후 경기는 CSV에 없습니다.
...
* 겹치는 열은 CSV와 raw가 같습니다. 예외로 `pitch_type` 10행만 다른데(Statcast 사후 재분류), 팀 표본과 똑같이 맞추려고 CSV 값을 씁니다.
